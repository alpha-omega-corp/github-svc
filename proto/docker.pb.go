...
var file_proto_docker_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x32, 0xa2, 0x03, 0x0a, 0x0d,
...
var file_proto_docker_proto_depIdxs = []int32{
	...
	6,  // 5: docker.DockerService.DeletePackage:input_type -> docker.DeletePackageRequest
	8,  // 6: docker.DockerService.GetContainers:input_type -> docker.GetContainersRequest
	10, // 7: docker.DockerService.GetContainerLogs:input_type -> docker.GetContainerLogsRequest
	1,  // 8: docker.DockerService.CreatePackage:output_type -> docker.CreatePackageResponse
	5,  // 9: docker.DockerService.GetPackages:output_type -> docker.GetPackagesResponse
	7,  // 10: docker.DockerService.DeletePackage:output_type -> docker.DeletePackageResponse
	9,  // 11: docker.DockerService.GetContainers:output_type -> docker.GetContainersResponse
	11, // 12: docker.DockerService.GetContainerLogs:output_type -> docker.GetContainerLogsResponse
