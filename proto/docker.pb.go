...
var file_proto_docker_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x22, 0x7b, 0x0a, 0x07, 0x50, 0x61, 0x63, 0x6b, 0x61,
	...
	0x66, 0x69, 0x6c, 0x65, 0x22, 0x45, 0x0a, 0x0d, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x50, 0x61,
	0x63, 0x6b, 0x61, 0x67, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x74, 0x61, 0x67, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x74, 0x61, 0x67, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x32, 0xe9, 0x03, 0x0a, 0x0d,
...
var file_proto_docker_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
...
var file_proto_docker_proto_depIdxs = []int32{
	...
	0,  // 3: docker.DockerService.CreatePackage:input_type -> docker.CreatePackageRequest
	4,  // 4: docker.DockerService.GetPackages:input_type -> docker.GetPackagesRequest
	2,  // 5: docker.DockerService.GetPackage:input_type -> docker.GetPackageRequest
	6,  // 6: docker.DockerService.DeletePackage:input_type -> docker.DeletePackageRequest
	8,  // 7: docker.DockerService.GetContainers:input_type -> docker.GetContainersRequest
	10, // 8: docker.DockerService.GetContainerLogs:input_type -> docker.GetContainerLogsRequest
	1,  // 9: docker.DockerService.CreatePackage:output_type -> docker.CreatePackageResponse
	5,  // 10: docker.DockerService.GetPackages:output_type -> docker.GetPackagesResponse
	3,  // 11: docker.DockerService.GetPackage:output_type -> docker.GetPackageResponse
	7,  // 12: docker.DockerService.DeletePackage:output_type -> docker.DeletePackageResponse
	9,  // 13: docker.DockerService.GetContainers:output_type -> docker.GetContainersResponse
